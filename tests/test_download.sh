...
test_download_youtube() {
  ...
  local output_file
  output_file="$("$root_script" --OUT_DIR ../temp --SPLITTER "" get "https://www.youtube.com/watch?v=XEjLoHdbVeE")"
...
test_download_soundcloud() {
  # script without parameters should give usage info
  local output_file
  output_file="$("$root_script" --OUT_DIR ../temp --SPLITTER "" get "https://soundcloud.com/kaytranada/janet-jackson-if-kaytranada")"
...
test_download_mixcloud() {
  # script without parameters should give usage info
  local output_file
  output_file="$("$root_script" --OUT_DIR ../temp --SPLITTER "" get "https://www.mixcloud.com/djsupermarkt_tooslowtd/minimix-for-tstd-edits-10-those-guys-from-athens-limited-colored-double-7/")"
...
test_download_apple_podcast() {
  # script without parameters should give usage info
  local output_file
  output_file="$("$root_script" --OUT_DIR ../temp --SPLITTER "" get "https://podcasts.apple.com/us/podcast/hearing-aids-by-roddy-doyle/id1281767970?i=1000632032467")"
